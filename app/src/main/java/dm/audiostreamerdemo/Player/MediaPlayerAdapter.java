package dm.audiostreamerdemo.Player;
...
public final class MediaPlayerAdapter extends PlayerAdapter {
     ...
     * created. In the onStop() method of the {@link dm.audiostreamerdemo.activity.MusicActivity} the {@link MediaPlayer} is
     * released. Then in the onStart() of the {@link dm.audiostreamerdemo.activity.MusicActivity} a new {@link MediaPlayer}
    ...
    private void playMediaUrl(String url) {
        boolean mediaChanged = (mMediaUrl == null || !url.equals(mMediaUrl));
        if (mCurrentMediaPlayedToCompletion) {
            // Last audio file was played to completion, the resourceId hasn't changed, but the
            // player was released, so force a reload of the media file for playback.
            mediaChanged = true;
        ...
        try {
            ...
            e.printStackTrace();
            throw new RuntimeException("Failed to Load Music Url: " + mMediaUrl , e);
